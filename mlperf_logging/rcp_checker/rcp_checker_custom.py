...
class RCP_Checker:
    ...
    def _check_directory(self, bs, subm_epochs, rcp_bypass=False):
        '''
...
if __name__ == "__main__":
    bs = 3*1024
    subm_epochs = [2308096, 2383360, 2458624, 2458624, 2508800, 2533888, 2533888, 2558976, 2558976, 2584064, 2609152, 2634240, 2684416, 2684416, 2734592, 2784768, 2784768, 2809856, 2885120, 3010560]

    checker = RCP_Checker("1.0.0", True)
    checker._compute_rcp_stats()

    test, msg = checker._check_directory(bs=bs, subm_epochs=subm_epochs)
